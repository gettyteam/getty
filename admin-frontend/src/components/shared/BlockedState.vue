<template>
  <div
    class="p-8 text-center border border-zinc-200 dark:border-zinc-800 rounded-2xl bg-white dark:bg-zinc-900 shadow-sm mb-6">
    <div
    ...
    <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
      {{
        t('configBlockedMessage', { name: moduleName }) ||
